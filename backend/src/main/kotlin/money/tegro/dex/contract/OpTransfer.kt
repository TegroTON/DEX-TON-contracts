...
data class OpTransfer(
    ...
    companion object : TlbCodec<OpTransfer> by OpTransferCombinator
}

private object OpTransferCombinator : TlbCombinator<OpTransfer>() {
    override val constructors: List<TlbConstructor<out OpTransfer>> = listOf(OpTransferConstructor)

    override fun getConstructor(value: OpTransfer): TlbConstructor<out OpTransfer> = OpTransferConstructor
