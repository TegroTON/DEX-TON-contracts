...
import {
    DeLabNetwork, DeLabTransaction, DeLabTypeConnect, DeLabConnecting,
    DeLabConnect, DeLabEvent, DeLabModal, DeLabScheme,
...
export function DeLabButtonLabel() {
    ...
    return (
        <>
            <img src={white} alt="DeLab Connect" style={{ width: '20px', marginRight: '10px' }} />
...
export const DeLabConnector = new DeLabConnect('https://pyAndr3w.dev', 'Web3 Dapp');
