...
export function SettingsModal() {
    ...
    const {swapInfo: {swapParams: {slippage: slippage}}} = dexInfo
                ...
                <div className="modal-content border-0 rounded p-40">
                    <div className="modal-header border-0 p-0 mb-40">
                        ...
                        <button type="button" className="btn p-0" data-bs-dismiss="modal"
                                aria-label="Close"><i className="fa-solid fa-xmark fa-lg"></i>
                        </button>
                    </div>
                    <div className="modal-body p-0">
                        <h4 className="fs-500 fs-18 text-muted mb-4">
                            ...
                            <a href="#!" className="text-muted ms-2 tooltips">
                                <i className="fa-regular fa-circle-question color-blue small"></i>
                        ...
                        <div className="row align-items-center">
                            <div className="col-6 col-lg-3 mb-2 mb-lg-0">
                                <a style={{cursor: "pointer"}} onClick={() => updateSlippage(0.1)}
                                   className={`btn d-block ${slippage === 0.1 ? "btn-primary" : "bg-soft-blue"}`}>0,1%</a>
                            </div>
                            <div className="col-6 col-lg-3 mb-2 mb-lg-0">
                                <a style={{cursor: "pointer"}} onClick={() => updateSlippage(0.5)}
                                   className={`btn d-block ${slippage === 0.5 ? "btn-primary" : "bg-soft-blue"}`}>0,5%</a>
                            </div>
                            <div className="col-6 col-lg-3 mb-2 mb-lg-0">
                                <a style={{cursor: "pointer"}} onClick={() => updateSlippage(1)}
                                   className={`btn d-block ${slippage === 1 ? "btn-primary" : "bg-soft-blue"}`}>1%</a>
                            </div>
                            <div className="col-6 col-lg-3 mb-2 mb-md-0">
                                <div className="input-group" style={{height: "50px"}}>
                                    <input type="number" className="form-control" defaultValue={slippage} min={0.1} max={99.9} step={0.1}
                                           style={[0.1, 0.5, 1].includes(slippage) ? {minHeight: "50px"} : {
                                               minHeight: "50px", backgroundColor: "#0d6efd", color: "#fff", borderColor: "#0d6efd"
                                           }}
